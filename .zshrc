...
export LESS=' -R '
export PYTHONPATH=$PYTHONPATH:/opt/pyscf:$HOME/Codes/banana:$HOME/Codes/cashew:$HOME/Codes/T3NS/python:$HOME/Codes/MFPS:$HOME/Codes/SecondQuantizationAlgebra
